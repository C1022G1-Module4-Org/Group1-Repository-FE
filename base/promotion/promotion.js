...
$("#addPromotionForm").submit(function (event) {
    ...
    let typeDto = $("#category").val();
    savePromotion(name, startDay, endDay, discount, typeDto);
});

function savePromotion(name, startDay, endDay, discount, typeDto) {
debugger
    $.ajax({
        type: 'POST',
...
$("#update-promotion").submit(function (event) {
    ...
    let typeDto = $("#category").val();
    updatePromotion(id, name, startDay, endDay, discount, typeDto);
})
...
function updatePromotion(id, name, startDay, endDay, discount, typeDto) {
    debugger
    $.ajax({
        type: "PUT",
        url: `http://localhost:8080/promotion/${id}`,
